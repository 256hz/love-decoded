...
export default () => {
	...
	const savedResponse = useSelector(
		getStepActivity(Courses.Two, Steps.Ten, Activities.Course2Step10Activity1),
	);

	const setResponse = (text: string) => dispatch(
		setStepActivityResponse(Courses.Two, Steps.Ten, Activities.Course2Step10Activity1, text),
	);

	return (
		<StepScreen
			nextTarget={Course2Step10Screens.Activities2}
